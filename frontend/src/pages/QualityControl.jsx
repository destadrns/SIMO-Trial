...
export default function QualityControl() {
  ...
  const qcRecords = data.qcChecklists.filter((record) => !query || [record.materialName, record.qcStatus, record.createdBy, record.createdByRole, record.notes, record.evidencePhoto].some((value) => String(value || '').toLowerCase().includes(query)));
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <input
        ...
        placeholder="Search QC material, status, inspector, notes..."
        aria-label="Search QC records"
      />
